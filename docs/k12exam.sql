...
--
-- Host: 11.47.36.32    Database: k12exam
-- ------------------------------------------------------
...
CREATE TABLE `class` (
  ...
  `class_code` varchar(255) DEFAULT '',
...
-- Dump completed on 2022-05-01 22:00:38
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:39
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:40
-- ************************************************************
--
-- close fk
--
...
--
-- Table structure for table `exam_paper_answer`
--
...
-- Dump completed on 2022-05-01 22:00:41
-- ************************************************************
--
-- close fk
--
...
--
-- Table structure for table `exam_paper_question_customer_answer`
--
...
CREATE TABLE `exam_paper_question_customer_answer` (
  ...
  `text_answer_id` int(11) DEFAULT NULL,
  `do_right` int(11) DEFAULT NULL,
  `create_user` int(11) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
-- Dump completed on 2022-05-01 22:00:42
-- ************************************************************
--
-- close fk
--
...
CREATE TABLE `message` (
  ...
  `send_user_name` varchar(255) DEFAULT '',
  `send_user_real_name` varchar(255) DEFAULT '',
...
CREATE TABLE `message_user` (
  ...
  `receive_user_name` varchar(255) DEFAULT '',
  `receive_user_real_name` varchar(255) DEFAULT '',
...
-- Dump completed on 2022-05-01 22:00:43
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:44
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:45
-- ************************************************************
--
-- close fk
--
...
--
-- Table structure for table `task_exam`
--
...
CREATE TABLE `task_exam` (
  ...
  `create_time` datetime DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `create_user_name` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2022-05-01 22:00:46
-- ************************************************************
--
-- close fk
--
...
--
-- Table structure for table `task_exam_customer_answer`
--
...
-- Dump completed on 2022-05-01 22:00:47
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:48
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2022-05-01 22:00:49
-- ************************************************************
--
-- close fk
--
