...
import com.polaris.exam.utils.ElAdminConstant;
import com.polaris.exam.utils.FileUtil;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    public MonitorServiceImpl(AdminCacheService cacheService) {
    ...
    public Map<String, Object> getServeInfo() {
        ...
        if(cacheService.getSystemInfo()!=null){
            return cacheService.getSystemInfo();
        }
        try {
        ...
        cacheService.setSystemInfo(resultMap);
        return resultMap;
    }
    /**
     * 获取内存信息
     ...
     * @return
     */
    public Map<String, Object> getMemoryInfo(GlobalMemory memory) {
     ...
     * @return
     */
    public Map<String, Object> getSystemInfo(OperatingSystem os) {
